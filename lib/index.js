...
import { inputRecord, outputRecord } from 'fortune/dist/lib/adapter/adapters/memory/helpers';
import { applyOptions } from 'fortune/dist/lib/adapter/adapters/common';
import applyUpdate from 'fortune/dist/lib/common/apply_update';
...
export default Adapter => class RedisAdapter extends Adapter {
  ...
  update(type, updatesArg) {
    if (!updatesArg.length) return super.update();
